...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
  ...
  public Void visitClassStmt(Stmt.Class stmt) {
    ...
    if (stmt.superclass != null) {
      ...
      if (!(superclass instanceof LoxClass)) {
        throw new RuntimeError(stmt.superclass.name,
                               "Superclass must be a Lox Class");
      }
    }
    this.enviroment.define(stmt.name.lexeme, null);
    if (stmt.superclass != null) {
    ...
    if (superclass != null) {
      this.enviroment = enviroment.enclosing;
    }
    this.enviroment.assign(stmt.name, klass);
    return null;
  }
  ...
  public Void visitFunctionStmt(Stmt.Function stmt) {
    LoxFunction function = new LoxFunction(stmt, this.enviroment, false);
